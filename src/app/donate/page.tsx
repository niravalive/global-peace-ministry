      ...
      <div className="flex flex-col w-full bg-cream min-h-screen">
         ...
         <section className="relative min-h-screen w-full flex flex-col justify-center items-center text-center px-6 md:px-12 bg-primary-900 overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
               <img
                  src="https://images.unsplash.com/photo-1761839257046-84e95464cc52?q=80&w=2338&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt="Community Help"
            ...
            <div className="absolute bottom-12 left-1/2 -translate-x-1/2">
               <button
                  ...
                  className="text-sm font-bold uppercase tracking-[0.2em] px-8 py-4 border border-white text-white hover:bg-white hover:text-primary-900 transition-colors duration-500 "
               >
                  Donate Now
               </button>
            </div>
